...
Repositório das aulas e materiais da disciplina de Pontes. O site é gerado com [Sphinx](https://www.sphinx-doc.org/) a partir de arquivos Markdown (MyST) e publicado automaticamente no GitHub Pages a cada push em `main`.
...
1. Crie um arquivo `.md` em `source/aulas/`, por exemplo `source/aulas/002-nome-da-aula.md`.
